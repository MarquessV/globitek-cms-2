...
?>
<?php $page_title = 'Staff: Edit Salesperson ' . $ogsalesperson['first_name'] . " " . $ogsalesperson['last_name']; ?>
<?php include(SHARED_PATH . '/header.php'); ?>

<div id="main-content">
  <a href="index.php">Back to Salespeople List</a><br />

  <h1>Edit Salesperson: <?php echo h($ogsalesperson['first_name'] . " " . $ogsalesperson['last_name']); ?></h1>
...
<br>
  <a href="show.php?id=<?php echo urlencode($salesperson['id'])?>">Cancel</a>
